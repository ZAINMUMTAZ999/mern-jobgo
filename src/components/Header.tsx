            ...
            {isLogged ? (
              <>
                <div className="hidden sm:flex items-center space-x-4">
                  ...
                  <Link
                    to="/search"
                    className="inline-flex items-center justify-center rounded-md bg-gray-200 px-4 py-2 text-sm font-medium text-gray-900 shadow-sm hover:bg-gray-300 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
                  >
                    Jobs
                  </Link>
                </div>
